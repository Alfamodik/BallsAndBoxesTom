...
namespace YG
{
    ...
    {
        public static bool IsAdTimerActive { get; private set; }
        ...
        IEnumerator CheckTimerAd()
        {
            while (true)
            {
                ...
                if (YG2.isTimerAdvCompleted && !YG2.nowAdsShow && !IsAnyWindowOpen())
                {
        ...
        {
            return UpgradeWindow.IsOpen || StatisticsWindow.IsOpen || SettingsWindow.IsOpen;
        }
